...
import repository.InMemoryRepository.FriendshipInMemoryRepository;
    ...
    private void writeToFile(Iterable<Friendship> entities) {
        ...
        try (BufferedWriter bufferedWriter = new BufferedWriter(new FileWriter(fileName, false))){
            for(Friendship friendship : entities) {
                String line = friendship.getId() + ";" + friendship.getFirstFriend()+";" + friendship.getSecondFriend()+";";
    ...
    private void loadData() {
        try (BufferedReader bufferedReader = new BufferedReader(new FileReader(fileName))){
            ...
            while ((line = bufferedReader.readLine()) != null) {
                ...
                Friendship friendship = new Friendship(Long.parseLong(attributes.get(0)), Long.parseLong(attributes.get(1)), Long.parseLong(attributes.get(2)));
                boolean ok = true;
